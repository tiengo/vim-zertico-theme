" Zertico Color Scheme
"
" Name:         zertico.vim
" Maintainer:   Celso Fernandes <fernandes@zertico.com>
" Last Change:  2015-05-08
" License:      MIT
" Version:      1.0
"
" Theme based on https://github.com/croaker/mustang-vim
" With improvement for Ruby and Puppet developers
...
hi Normal guifg=#e2e2e5 guibg=#202020 gui=none ctermfg=253 ctermbg=000
...
hi CursorLineNr ctermfg=DarkMagenta guifg=#2b506e guibg=#000000

hi Search guifg=#d0d0d0 gui=none ctermfg=252 guibg=#875faf ctermbg=97
hi String guifg=#bcbcbc gui=italic ctermfg=250
...
hi x030_DodgerBlue2 ctermfg=27 guifg=#005fff "rgb=0,95,255
...
hi x077_SteelBlue1 ctermfg=75 guifg=#5fafff "rgb=95,175,255
...
hi x097_MediumPurple3 ctermfg=98 guifg=#875faf "rgb=135,95,175
